...
Rectangle {
    ...
    GridLayout{
        ...
        ListModel {
            ...
            ListElement { first: "ARC/eARC OUT SETUP"; number: 2 }
            ListElement { first: "VITALS"; number: 3 }
            ListElement { first: "FAN CONTROL";number: 4 }
            ListElement { first: "RESET & REBOOT"; number: 5 }
            ListElement { first: "Tools"; number: 6 }
            ListElement { first: "POWER OUT "; number: 7 }
        }
        Repeater{
            model: edid_model
            CustomButton{
    ...
    GridLayout{
        ...
        ListModel {
            id: out_setup_model
            ListElement { first: "DISABLE ARC/eARC"; number: 0x00 }
            ListElement { first: "ENABLE eARC"; number:0x01 }
            ListElement { first: "ENABLE ARC"; number: 0x02 }
        }
        Repeater{
            ...
            CustomButton{
                width:btnWidth
                height:btnHeight
                border.color: out_setup_flag==number?"orange":"black"
                border.width: 4
                color: 'black'
                Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                Column{
                ...
                MouseArea{
                    anchors.fill: parent
                    onClicked: {
                        out_setup_flag=number
                        confirmsignal("ARC/eARC_OUT",number)
                    }
                }
            }
        }
    ...
    GridLayout{
        ...
        ListModel {
            ...
            ListElement { first: "OFF"; number: 0x00 }
            ListElement { first: "LOW SPEED"; number:0x01 }
            ListElement { first: "MIDDLE SPEED"; number: 0x02 }
            ListElement { first: "HIGH SPEED"; number: 0x03 }
            ListElement { first: "AUTO"; number: 0x04 }
        }
        Repeater{
