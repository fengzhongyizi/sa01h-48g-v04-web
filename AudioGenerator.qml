...
Rectangle {
    ...
    //pcm-volume
    property int pcm_volume_value: -30
    RowLayout {
            ...
            ScrollView{
                ...
                GridLayout{
                    ...
                    ListModel {
                        ...
                        ListElement { first:"2CH (FR_FL)"; number:0x00 }
                        ListElement { first:"2.1CH (LFE_FR_FL)"; number: 0x01 }
                        ListElement { first:"3CH (FC_FR_FL)"; number: 0x02 }
                        ListElement { first:"3.1CH (FC_LFE_FR_FL)"; number: 0x03 }
                        ListElement { first:"3CH (RC_FR_FL)"; number: 0x04 }
                        ListElement { first:"3.1CH (RC_LFE_FR_FL)"; number: 0x05 }
                        ListElement { first:"4CH (RC_LFE_FR_FL)"; number: 0x06 }
                        ListElement { first:"4.1CH (RC_FC_LFE_FR_FL)"; number: 0x07 }
                        ListElement { first:"4CH (RR_RL_FR_FL)"; number: 0x08 }
                        ListElement { first:"4.1CH (RR_RL_LFE_FR_FL)"; number: 0x09 }
                        ListElement { first:"5CH (RR_RL_FC_FR_FL)"; number: 0x0a }
                        ListElement { first:"5.1CH (RR_RL_FC_LFE_FR_FL)"; number: 0x0b }
                        ListElement { first:"5CH (RC_RR_RL_FR_FL)"; number: 0x0c }
                        ListElement { first:"5.1CH (RC_RR_RL_LFE_FR_FL)"; number: 0x0d }
                        ListElement { first:"6CH (RC_RR_RL_FC_FR_FL)"; number: 0x0e }
                        ListElement { first:"6.1CH (RC_RR_RL_FC_LFE_FR_FL)"; number: 0x0f }
                        ListElement { first:"6CH (RRC_RLC_RR_RL_FR_FL)"; number: 0x10 }
                        ListElement { first:"6.1CH (RRC_RLC_RR_RL_LFE_FR_FL)"; number: 0x11 }
                        ListElement { first:"7CH (RRC_RLC_RR_RL_FC_FR_FL)"; number: 0x12 }
                        ListElement { first:"7.1CH (RRC_RLC_RR_RL_FC_LFE_FR_FL)"; number: 0x13 }
                        ListElement { first:"4CH (FRC_FLC_FR_FL)"; number: 0x14 }
                        ListElement { first:"4.1CH (FRC_FLC_LFE_FR_FL)"; number: 0x15 }
                        ListElement { first:"5CH (FRC_FLC_FC_FR_FL)"; number: 0x16 }
                        ListElement { first:"5.1CH (FRC_FLC_FC_LFE_FR_FL)"; number: 0x17 }
                        ListElement { first:"5CH (FRC_FLC_RC_FR_FL)"; number: 0x18 }
                        ListElement { first:"5.1CH (FRC_FLC_RC_FC_FR_FL)"; number: 0x19 }
                        ListElement { first:"6CH (FRC_FLC_RC_FC_FR_FL)"; number: 0x1a }
                        ListElement { first:"6.1CH (FRC_FLC_RC_FC_LFE_FR_FL)"; number: 0x1b }
                        ListElement { first:"6CH (FRC_FLC_RR_RL_FR_FL)"; number: 0x1c }
                        ListElement { first:"6.1CH (FRC_FLC_RR_RL_LFE_FR_FL)"; number: 0x1d }
                        ListElement { first:"7CH (FRC_FLC_RR_RL_FC_FR_FL)"; number: 0x1e }
                        ListElement { first:"7.1CH (FRC_FLC_RR_RL_FC_LFE_FR_FL)"; number: 0x1f }
